...
export function HomePage() {
  return <>
    ...
    <section className="flow section"><SectionHeading eyebrow="FIRST VISIT" title="初めての方にも、安心して休んでいただくために。" /><FlowSteps /></section>
